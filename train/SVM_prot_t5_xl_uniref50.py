...
file_name = "prot_t5_xl_uniref50.csv"
...
for fold_index, (train_index, val_index) in enumerate(fold_indices, 1):
    ...
    model_filename = os.path.join(seed_weight_dir, f"SVM_prot_t5_xl_uniref50_fold_{fold_index}.pt")
...
metrics_filename = os.path.join(seed_weight_dir, "SVM_prot_t5_xl_uniref50_fold_metrics.txt")
